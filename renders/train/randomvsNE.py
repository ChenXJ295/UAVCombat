...
for i in range(300):
    ...
    action_random1 =[]
    action_random = []
    action_random.append(random.randint(0,40))
    action_random.append(random.randint(0,40))
    action_random.append(random.randint(0,40))
    action_random.append(random.randint(0,29))
    action_random1.append(action_random)
    actions = np.concatenate((ego_actions, action_random1), axis=0)
...
test.to_csv('2.csv')  # 数据存入csv,存储位置及文件名称