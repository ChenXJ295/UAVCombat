...
with plt.style.context(['science', 'ieee','grid']):
    ...
    data_grid = pd.read_csv('C:\\Users\\wx\\Desktop\\小论文\\ab_data\\grid_sum.csv')
    data_box = pd.read_csv('C:\\Users\\wx\\Desktop\\小论文\\ab_data\\boxing_sum.csv')
    data_pong = pd.read_csv('C:\\Users\\wx\\Desktop\\小论文\\ab_data\\pong_sum.csv')
